  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!date || !formData.timeSlot || !selectedLGA) {
      toast({
        ...
        description: "Please fill in all required fields including date, time slot, and local government area.",
        variant: "destructive"
      });
      return;
    }
    ...
    const orderData = {
      ...
      location: {
        lga: localGovernmentAreas.find(area => area.value === selectedLGA)?.label,
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Select value={selectedLGA} onValueChange={setSelectedLGA} required>
                ...
                <div>
                  ...
                  <Select value={formData.timeSlot} onValueChange={(value) => setFormData({...formData, timeSlot: value})} required>
                    <SelectTrigger className="transition-all duration-200 hover:scale-105">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-orange-600 hover:bg-orange-700 transition-all duration-200 transform hover:scale-105" 
                  size="lg"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg animate-fade-in">
                  <p className="text-sm text-blue-800">
                    <strong>Payment Methods:</strong> We accept all major debit/credit cards, bank transfers, and mobile money through Paystack.
                  </p>
                </div>
              </div>
            </CardContent>
