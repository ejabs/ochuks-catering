...
const Catering = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-red-500 to-orange-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">
            Private Catering Services
          </h1>
          <p className="text-xl lg:text-2xl mb-8">
            Make your special events unforgettable with our premium catering
            services
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Complete wedding packages including custom cakes, dessert
                  tables, and full meal service.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-gray-600">
                  Birthday parties, anniversaries, and special celebrations with
                  customized menus.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="space-y-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Our experienced team ensures seamless service from planning
                    to execution.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    We create personalized menus to match your event theme and
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Only the finest, freshest ingredients are used in all our
                    catering services.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    From intimate gatherings to large celebrations, we have
                    packages for every size and budget.
                  </p>
                </CardContent>
              </Card>
            </div>
